...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'user_role:admin|staff']], function(){
	...
	//add Credit
	Route::get('/transaction-add-credit', 'ShipmentController@giveAmount')->name('admin.transactions.addCredit');
...
Route::post('user/add-credit','ShipmentController@saveCredit')->name('add.credit.amount');
Route::get('admin/add-credit/add/{id}/{user_id}/{client_id}','ShipmentController@addCredit')->name('admin.add.credit.amount');
