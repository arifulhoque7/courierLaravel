...
<head>
    ...
    @else
    <title>@if(View::hasSection('meta_title')) @yield('meta_title') | @endif {{ translate('Akash Parcel') }}</title>
    @endif
    ...
    <link rel="canonical" href="https://getbootstrap.com/docs/4.4/components/carousel/">
    ...
    <link rel="stylesheet" href="{{ static_asset('themes/main/frontend/logistic/css/flation.css')}}">
    @endif
    ...
    body{
        ...
        font-family: "{{ setting()->get('primary_font_'.app()->getLocale()) ?? 'Poppins' }}";
        font-weight: 400;
    }
    :root{
