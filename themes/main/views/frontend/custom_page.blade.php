...
@section('content')
    <!--Page Header-->
    <section id="main-banner-page" style="background-image: url('public/uploads/all/oTnJkBEkdiJVYaSRhYKkGnQrRUrxx3i7BiR9zuOP.jpg');" class="position-relative page-header about-header @if(setting()->get('internal_pages_header_'.app()->getLocale())) parallax @endif section-nav-smooth" @if(setting()->get('internal_pages_header_'.app()->getLocale())) style="background-image: url({{asset('/storage/app/public/'. setting()->get('internal_pages_header_'.app()->getLocale()) )}})" @endif>
    ...
    <section class="bglight padding_top padding_bottom_half" style="padding-top: 4.5rem!important;">
        <div class="container">
            <div class="row">
                <div class="col-12 p-5 bg-white rounded shadow-sm overflow-hidden">
