...
<header class="site-header" id="header">
    <nav class="navbar navbar-expand-lg transparent-bg @if(setting()->get('main_header_stikcy_'.app()->getLocale())) static-nav @endif" style="background: #00000059;">
        <div class="container">
            <a class="navbar-brand" href="{{url('/')}}">
                ...
                <img src="@if(setting()->get('sticky_header_logo_'.app()->getLocale()) && setting()->get('sticky_header_logo_'.app()->getLocale()) != '') {{asset('/storage/app/public/'. setting()->get('sticky_header_logo_'.app()->getLocale()) )}} @else {{ static_asset('themes/main/frontend/logistic/images/Akash Parcel@300x.png')}} @endif" alt="logo" class="logo-scrolled">
            </a>
