...
<div class="px-8 py-8 row justify-content-center py-md-10 px-md-0">
    ...
    <div class="col-md-9">
        <div class="table-responsive scroll_true">
            <table class="table">
                <thead>
                    <tr>
                        <th class="pl-0 font-weight-bold text-muted text-uppercase">{{translate('Shipment Code')}}</th>
                        <th class=" font-weight-bold text-muted text-uppercase">{{translate('Status')}}</th>
                        <th class="text-right font-weight-bold text-muted text-uppercase">{{translate('Customer Name')}}</th>
                        <th class="text-right font-weight-bold text-muted text-uppercase">{{translate('Customer Address')}}</th>
                        <th class="text-right font-weight-bold text-muted text-uppercase">{{translate('Customer Phone')}}</th>
                        <th class="text-right font-weight-bold text-muted text-uppercase">{{translate('Branch')}}</th>
                        <th class="text-right font-weight-bold text-muted text-uppercase">{{translate('Marchant Name')}}</th>
                ...
                @php
                //  dd($shipment_mission->shipment->reciver_name);
                // dd($shipment_mission->shipment);
                ...
                @endphp
                    ...
                    <tr class="font-weight-boldest @if(in_array($shipment_mission->shipment->status_id ,[\App\Shipment::RETURNED_STATUS,\App\Shipment::RETURNED_STOCK,\App\Shipment::RETURNED_CLIENT_GIVEN])) table-danger @endif">
                        ...
                        <td class="text-right pt-7">{{ $shipment_mission->shipment->reciver_name }}</td>
                        <td class="text-right pt-7">{{ $shipment_mission->shipment->reciver_address }}</td>
                        <td class="text-right pt-7">{{ $shipment_mission->shipment->reciver_phone }}</td>
