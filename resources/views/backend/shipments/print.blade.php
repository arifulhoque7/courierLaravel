                    ...
                    <div class="col-md-9">
                        <div class="pb-10 d-flex justify-content-between pb-md-20 flex-column flex-md-row">
                            <h1 class="mb-10 display-4 font-weight-boldest">
                                ...
                                @else
                                    <img src="{{ static_asset('assets/img/Akash Parcel@300x.png') }}" class="mb-5 d-block" style="max-width: 240px;">
                                @endif
                                {{translate('INVOICE')}}
                            </h1>
                        ...
                        <div class="pt-6 d-flex justify-content-between">
                            ...
                            <div class="d-flex flex-column flex-root">
                                <span class="mb-2 font-weight-bolder">{{translate('AMOUNT TO BE COLLECTED (IF POSTPAID)')}}</span>
                                <span class="opacity-70">{{format_price($shipment->amount_to_be_collected)}}
                            </div>
                            <div class="d-flex flex-column flex-root">
                                <span class="mb-2 font-weight-bolder">{{translate('SHIPPING COST')}}</span>
                                <span class="opacity-70">{{format_price($shipment-> shipping_cost)}}
                            </div>
                        </div>
                    </div>
                </div>
