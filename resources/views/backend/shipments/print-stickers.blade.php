										...
										<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
											<tr>
												<td valign="middle" style="padding-left:5px; height: 90px;">
													...
													@else
														<img src="{{ static_asset('assets/img/Akash Parcel@300x.png') }}" style="max-width: 377px">
													@endif
												</td>
											</tr>
										</table>
																...
																<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
																	<tr>
																		<td style="padding-left:10px; font-size:14px; font-weight:bold; width:420px">
																			@if(get_setting('site_name')){{ get_setting('site_name').get_setting('site_motto') ?' | '.get_setting('site_motto'):'' }}{{ translate('Akash Parcel') }}@else{{ translate('Akash Parcel') }}@endif
																		</td>
																		<td nowrap="nowrap">
														...
														<tr>
															<td style="padding:5px; font-size:12px;">
																<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    {{$model->reciver_name}}<br />
                                                                    {{$model->reciver_phone}}<br />
                                                                    {{$model->reciver_address}}
                                                                </td>
																	</tr>
																</table>
															</td>
