...
<head>
	...
	@else
		<title>{{ translate('Akash Parcel') }}</title>
	@endif
...
<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="{{ route('admin.dashboard') }}">
            ...
            @else
                <img src="{{ static_asset('assets/img/Akash Parcel@300x.png') }}" alt="{{ get_setting('site_name') }}" class="max-w-103px">
            @endif
        </a>
                                                ...
                                                <div class="col-md-7 col-lg-12 col-xxl-7">
                                                        ...
                                                        <div class="pb-20 card-body p-15">
                                                            <div class="row mb-17">
                                                                ...
                                                                <div class="col-xxl-7 pl-xxl-11">
                                                                    <h2 class="font-weight-bolder text-dark mb-7" style="font-size: 32px;">{{translate('Merchant')}}: {{$shipment->client->name}}</h2>
                                                                    <div class="font-size-h2 mb-7 text-dark-50">{{translate('To Customer')}}
                                                    ...
                                                    <div class="card card-custom card-stretch gutter-b">
														...
														<div class="d-flex justify-content-between">
															{{translate('Thank you for paying the shipping cost')}}
															<a href="{{route('admin.shipments.show', ['shipment'=>$shipment->id])}}"> {{translate('Back To Shipment')}}</a>
															<a href="{{route('admin.dashboard')}}"> {{translate('Back To Dashboard')}}</a>
														</div>
                                                    </div>
                                                    <!--end::Engage Widget 14-->
                                                </div>
