...
@php
    ...
    if($user_type == 'customer'){
    $client_id = DB::table('user_client')
        ->where('id', $auth_user->userClient->id)
        ->value('client_id');
    $mobile = DB::table('clients')
        ->where('id', $client_id)
        ->value('mobile');

        $address = DB::table('clients')
        ->where('id', $client_id)
        ->value('address');
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group client-select">
                                    <label>{{translate('Merchant/Shop Name')}}:</label>
                                    @if($auth_user->user_type == "customer")
                                        ...
                                        <input type="hidden" name="Shipment[client_address]" value="{{$address}}">
                                    @else
                                        <select class="form-control kt-select2 select-client" id="client-id" onchange="selectIsTriggered()" name="Shipment[client_id]">
                                            <option></option>
                                            @foreach($clients as $client)
                                            <option value="{{$client->id}}" data-phone="{{$client->mobile}}">{{$client->name}}</option>
                                            @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if($auth_user->user_type == "customer")
                                    <label>{{translate('Merchant Phone')}}:</label>
                                    <input placeholder="{{translate('Client Phone')}}" name="Shipment[client_phone]" value="<?php echo $mobile;?>" id="client_phone" class="form-control" readonly=""/>
                                    @else
                                    <label>{{translate('Merchant Phone')}}:</label>
                                    <input placeholder="{{translate('Client Phone')}}" name="Shipment[client_phone]" id="client_phone" class="form-control"  />
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                     <label>{{translate('Merchant Address')}}:</label>
                                    @if($auth_user->user_type == "customer")
                                    <input placeholder="{{translate('Client Address')}}" name="Shipment[client_address]" value="<?php echo $address;?>" id="" class="form-control" readonly=""/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Customer Name')}}" name="Shipment[reciver_name]" class="form-control" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Customer Phone')}}" name="Shipment[reciver_phone]" class="form-control" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="{{translate('Customer Address')}}" name="Shipment[reciver_address]" class="form-control" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{translate('From District')}}:</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{translate('To District')}}:</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control kt-select2 payment-type" id="payment_type" name="Shipment[payment_type]">
                                        <option @if(\App\ShipmentSetting::getVal('def_payment_type')=='1' ) selected @endif value="1">{{translate('COD(Cash On Delivery)')}}</option>
                                        <option @if(\App\ShipmentSetting::getVal('def_payment_type')=='2' ) selected @endif value="2">{{translate('Only Delivery')}}</option>
                                    </select>
                        ...
                        <div id="kt_repeater_1">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{translate('Delivery Package')}}:</label>
...
<script type="text/javascript">
    ...
    function get_estimation_cost() {
        ...
        //my edit
        var derivary_time = document.getElementsByName("Shipment[delivery_time]")[0].value;
