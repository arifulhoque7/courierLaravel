                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control kt-select2" id="select-how" name="Shipment[delivery_time]">
                                            ...
                                            <option @if($shipment->delivery_time == "Regular") selected @endif value="Regular">{{translate('Regular')}}</option>
                                            <option @if($shipment->delivery_time == "On-Demand") selected @endif value="On-Demand">{{translate('On-Demand')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
