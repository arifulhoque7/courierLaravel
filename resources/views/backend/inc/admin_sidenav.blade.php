...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{ route('admin.dashboard') }}" class="brand-logo">
            @if(get_setting('system_logo_white') != null)
                <img src="{{ uploaded_asset(get_setting('system_logo_white')) }}" style="width:100%;" alt="@if(get_setting('site_name')) {{ get_setting('site_name') }} @else {{ translate('Akash Parcel') }} @endif">
            @else
                <img src="{{ static_asset('assets/img/Akash Parcel@300x.png') }}"  alt="@if(get_setting('site_name')) {{ get_setting('site_name') }} @else {{ translate('Akash Parcel') }} @endif">
            @endif
        </a>
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="mb-4 aside-menu" data-menu-vertical="1" data-menu-scroll="1"
