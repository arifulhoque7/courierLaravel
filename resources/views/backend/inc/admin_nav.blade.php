                    ...
                    <form>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="topbar_notifications_notifications" role="tabpanel">
                                ...
                                @if (\Auth::user()->unreadNotifications->count() > 0)
                                    <!--begin::Nav-->
                                    <div class="navi navi-hover scroll mb-4" data-scroll="true" data-height="300"
                                        data-mobile-height="200">


                                        @foreach (\Auth::user()->unreadNotifications as $key => $item)
                                            <!--begin::Item-->
                                            <a href="{{ route('notification.view', ['id' => $item->id]) }}"
                                                class="navi-item">
                                                <div class="navi-link">
                                                    ...
                                                    <div class="navi-text">
                                                        <div class="font-weight-bold">
                                                            {{ $item->data['message']['subject'] }}</div>
                                                        <div class="text-muted">
                                                            {{ $item->created_at->diffForHumans(null, null, true) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                                ...
                                @else
                                    ...
                                    <div class="d-flex flex-center text-center text-muted min-h-200px">
                                        {{ translate('All caught up!') }}
                                        <br>{{ translate('No new notifications') }}.
                                    </div>
                                    <!--end::Nav-->
                                @endif
                            </div>
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
                    <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
                        ...
                        @if (Auth::user()->user_type == 'customer' && Auth::user()->avatar_original == null)
                            <div class="symbol symbol-30 mr-3">
                                <img src="{{ static_asset('uploads/all/' . $image) }}"
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    ...
                    <!--begin::Header-->
                    <div
                        class="d-flex align-items-center justify-content-between flex-wrap p-8 bg-dark-o-5 bgi-no-repeat rounded-top">
