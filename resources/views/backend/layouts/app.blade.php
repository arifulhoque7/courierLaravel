...
<head>
	...
	@else
		<title>@if(View::hasSection('sub_title')) @yield('sub_title') | @endif {{ translate('Akash Parcel') }} </title>
	@endif
...
<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="{{ route('admin.dashboard') }}">
            ...
            @else
                <img src="{{ static_asset('assets/img/Akash Parcel@300x.png') }}" alt="{{ get_setting('site_name') }}" class="max-h-25px">
            @endif
        </a>
				...
				<div class="py-4 bg-white footer d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container text-center">
						...
						<div class="order-2 text-dark order-md-1">
							...
							<a href="https://appatlantis.com/" target="_blank"
								class="text-dark-75 text-hover-primary">{{translate('App Atlantis Corp.')}}</a> <span class="mr-2 text-muted font-weight-bold">{{translate('v')}} 1.0</span>
						</div>
